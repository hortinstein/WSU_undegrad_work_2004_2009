...
int main(int argc, char *argv[], char *env[])
{
	...
	char *PATH_,command[5000],temp_command[5000], *parsed[5000],*dir_list[100];
	printf("****************************\n"); 	
	printf("***Welcome to HortinShell***\n");
	printf("****************************\n"); 
	...
	numdir = i;
	printf("...number of directories in $PATH: %d\n", numdir);
