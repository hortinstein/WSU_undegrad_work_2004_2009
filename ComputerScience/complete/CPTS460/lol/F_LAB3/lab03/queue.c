...
/***********************************************************************
 * printList
 * Description: Prints the contents of the list by traversing the
 *              linked list and printing it.
 * Params:      None.
 * Return:      None.
 *
 **********************************************************************/
void printList( list ) PROC * list;       /* print freeList */
{
    PROC * p = list;
...
/***********************************************************************
 * printsleep
 * Description: Prints the contents of the sleepList by traversing the
 *              linked list and printing it.
 * Params:      None.
 * Return:      None.
 *
 **********************************************************************/
void printsleep()       /* print freeList */
{
    PROC * p = sleepList;

    while (p) {
        printf("[P%d, event=%d] -> ",p->pid, p->event);
        p = p->next;
    }
