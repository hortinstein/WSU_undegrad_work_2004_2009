...
// ACCESS and MUTATE
   ...
   /// erase (range)
   /// \pre    Their must be an array with which to erase data.
   /// \post   An the array is modified without the erased values
   /// \param  None
   /// \return None
   /// \throw  None
   void erase( VecIterator<Element> i_start, VecIterator<Element> i_end);
...
/// erase (range)
/// \pre    Their must be an array with which to erase data.
/// \post   An array with data is erased at range and the pointer Iterator is invalid
/// \param  Iterator i_start for the beginning of the range
/// \param  Iterator i_end for the end of the range
/// \return None
/// \throw  None
///////////////////////////////////////////////////////////////////////
template < class Element >
void Vec< Element >::erase(  VecIterator<Element> i_start, VecIterator<Element> i_end)
{
   
   VecIterator<Element> temp = i_start;
   while (temp != i_end)
   {
      temp = erase(temp);
      temp++;
