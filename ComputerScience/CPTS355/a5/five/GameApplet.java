...
public class GameApplet extends Applet implements Runnable, MouseListener {
    ...
    String landedMessage = "You live to see your wife and family";
    String crashedMessage = "pwned...the only thing that is left of you is bl00dy entrails";
    Image myImage;
    Image myImageLander;
    ...
    public void init() {
		...
		myEpicFail = getImage(getCodeBase(), "apolloLanderCrash.gif");
        myEpicWin = getImage(getCodeBase(), "apolloLanderLanded.gif");
    ...
    public void update(Graphics g) {
        ...
        if (reachedSurface)
		{
            ...
            if (landed)
			{
				g.drawImage(myEpicWin,  300, 350 - (int) herrosoviets.getHeight(), this);
                g.drawString(landedMessage, 50, 50);
			}            
			else
			{
				g.drawImage(myEpicFail,  300, 350 - (int) herrosoviets.getHeight(), this);
