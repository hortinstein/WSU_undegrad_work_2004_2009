...
static void qtn_normalize(double [4]);
...
trackball(double q[4], double p1x, double p1y, double p2x, double p2y)
{
    ...
    qtn_fromAxis(a,phi,q);
}

/*
 *  Given an axis and angle, compute quaternion.
 */
void qtn_fromAxis(double a[3], double phi, double q[4])
{
    vnormal(a);
    vcopy(a,q);
...
void
qtn_add(double q1[4], double q2[4], double dest[4])
{
    static int count=0;
 ...
 */
static void qtn_normalize(double q[4])
{
    int i;
    double mag;
 ...
 *
 */
void qtn_asRotmatrix(double q[4], double m[16])
{
